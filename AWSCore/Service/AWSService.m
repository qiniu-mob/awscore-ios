...
static NSString *const QNRegionNameCNNorth1 = @"cn-north-1";
static NSString *const QNRegionNameCNEast1 = @"cn-east-1";
static NSString *const QNRegionNameCNSouth1 = @"cn-south-1";
...
static NSString *const QNServiceNameMOB = @"mob";
...
- (NSString *)regionNameFromType:(AWSRegionType)regionType {
    switch (regionType) {
        ...
        case QNRegionCNNorth1:
            return QNRegionNameCNNorth1;
        case QNRegionCNEast1:
            return QNRegionNameCNEast1;
        case QNRegionCNSouth1:
            return QNRegionNameCNSouth1;
        default:
            return nil;
    }
}
...
- (NSURL *)URLWithRegion:(AWSRegionType)regionType
    ...
    } else if (serviceType == QNServiceMOB) {
        if (regionType == QNRegionCNEast1) {
            URL = [NSURL URLWithString:@"https://cn-east-1-mob.qiniuapi.com"];
        } else if (regionType == QNRegionCNSouth1) {
            URL = [NSURL URLWithString:@"https://cn-south-1-mob.qiniuapi.com"];
        } else {
            URL = [NSURL URLWithString:@"https://mob.qiniuapi.com"];
        }
    } else {
    ...
    if ([regionName hasPrefix:@"cn"] && (serviceType !=QNServiceMOB)) {
